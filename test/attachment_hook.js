    ...
    UploadFile.prototype = {
        ...
        initUploader: function () {
            var _this = this,
                ...
                unacceptExtensions = (editor.getOpt('fileForbitFiles') || []).join('').replace(/\./g, ',').replace(/^[,]/, '');
            ;
            ...
            uploader = _this.uploader = WebUploader.create({
                ...
                duplicate: true,
                fileSingleSizeLimit: 599073741824,
                compress: false
            });
            uploader.addButton({
                id: '#filePickerBlock'
            ...
            function addFile(file) {
                ...
                if (file.getStatus() === 'invalid') {
                    ...
                    /* 检查文件格式 */
                    if (!file.ext || unacceptExtensions.indexOf(file.ext.toLowerCase()) >= 0) {
